...
export default function StockInSection() {
  return (
    <section id="merchandising" className="py-24 sm:py-32 bg-yellow relative overflow-hidden honeycomb-bg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <motion.h2
              ...
              className="text-3xl sm:text-4xl font-bold text-navy mb-8 leading-tight"
            >
              Retail merchandising services that move your product — not just your packaging.
            </motion.h2>
              ...
              {features.map((feature, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-indigo/80 leading-relaxed">{feature.description}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <motion.div
            ...
            className="bg-navy/10 rounded-2xl aspect-[4/3] flex items-center justify-center"
          >
            <span className="text-navy/30 text-sm font-medium">Merchandising Image</span>
          </motion.div>
        </div>
      </div>
    </section>
